(function(g) {
    "function" === typeof define && define.amd ? define(["jquery", "datatables.net", "datatables.net-buttons"], function(j) { return g(j, window, document) }) : "object" === typeof exports ? module.exports = function(j, m) {
        j || (j = window);
    ...
    function o(a, b, d) {
        ...
        d && (d.attr && g(c).attr(d.attr), d.children && g.each(d.children, function(a, b) { c.appendChild(b) }), null !== d.text && d.text !== p && c.appendChild(a.createTextNode(d.text)));
        return c
    }
    ...
    i.Client.prototype = {
        ...
        destroy: function() {
            var a = this;
            this.domElement && this.div && (g(this.div).remove(), this.div = this.domElement = null, g.each(i.clients, function(b, d) { d === a && delete i.clients[b] }))
        },
    ...
    h.Api.register("buttons.resize()", function() { g.each(i.clients, function(a, b) { b.domElement !== p && b.domElement.parentNode && b.positionElement() }) });
    h.ext.buttons.copyFlash = g.extend({}, u, {
        ...
        action: function(a, b, d, c) {
            if (c._fromFlash) {
                ...
                t(a, e);
                this.processing(!1);
                b.buttons.info(b.i18n("buttons.copyTitle", "Copiar al portapapeles"), b.i18n("buttons.copySuccess", { _: "Copied %d rows to clipboard", 1: "Copied 1 row to clipboard" }, data.rows), 3E3)
            }
        },
        fieldSeparator: "\t",
        fieldBoundary: ""
    ...
    h.ext.buttons.excelFlash = g.extend({}, u, {
        ...
        action: function(a, b, d, c) {
            ...
            n = 0;
            for (s = k.header.length; n < s; n++) h.appendChild(o(f, "col", { attr: { min: n + 1, max: n + 1, width: C(k, n), customWidth: 1 } }));
