...
<body class="hold-transition sidebar-mini layout-fixed" data-panel-auto-height-mode="height">
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <!-- Sidebar -->
            <?php include("lateral_supervisor.php") ?>
            <!-- /.sidebar -->
        </aside>
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1><img src="../../dist/img/mia.png" width="60" height="60"> Terreno | Equipos </h1>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
            </section>
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <center>
                                                    <div class="form-group">
                                                        <input type="date" class="form-control" id="fecha_equipo" name="fecha_equipo">
                                                    </div>
                                                </center>
                                            </div>
                                            <div class="col-sm-6">
                                                <label>Ubicación</label>
                                                <select class="form-control" id="id_ub_equipo" name="id_ub_equipo">
                                                    <option value=""> </option>
                                                    <?php
