...
if ($mes == "") {
    ...
    $mes00 = $row00['mes'];
    $ano00 = $row00['ano'];
    $sql11 = "SELECT count(se.id_sal_equipo) as cantidad FROM salida_equipos se inner join lista_equipos le on se.id_equipo = le.id_equipo where le.id_tequipo = 2 and se.fecha between '" . $ano00 . "-" . $mes00 . "-01' and '" . $ano00 . "-" . $mes00 . "-" . $dia00 . "'";
    ...
    for ($i = 1; $i <= $dia0; $i++) {
        $sql1 = "SELECT count(se.id_sal_equipo) as cantidad FROM salida_equipos se inner join lista_equipos le on se.id_equipo = le.id_equipo where le.id_tequipo = 2 and se.fecha = '" . $ano0 . "-" . $mes0 . "-" . $i . "'";
        $result1 = mysqli_query($con, $sql1);
        $row1 = mysqli_fetch_array($result1);
