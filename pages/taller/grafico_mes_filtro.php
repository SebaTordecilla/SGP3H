...
$tabla = "<input type=\"hidden\" class=\"form-control\" id=\"lista_equipos\" name=\"lista_equipos\" value=\"" . substr($totaldias, 0, -1) . "\"><input type=\"hidden\" class=\"form-control\" id=\"lista_equipos3\" name=\"lista_equipos3\" value=\"" . substr($syc, 0, -1) . "\"><input type=\"hidden\" class=\"form-control\" id=\"lista_equipos4\" name=\"lista_equipos4\" value=\"" . substr($dump, 0, -1) . "\"><input type=\"hidden\" class=\"form-control\" id=\"diasmes\" name=\"diasmes\" value=\"" . $diasmes . "\">";
