...
$resultado = $mysqli->query("SELECT em.id_extmin, em.fecha,um.nombre as id_ubicacion1,le.sigla as id_equipo1, upper(o.nombre) as id_op1, 
    ...
    inner join minerales mn on mn.id_mineral = em.id_mineral left join observaciones_minerales osm on em.id_obs_min = osm.id_obs_min where em.estado =2 and month(em.fecha)=" . $mes . " and year(em.fecha)=" . $ano . ";");

$total = $resultado->num_rows;

if ($total > 0) {
    $tabla = "<table id=\"example1\" class=\"table table-sm\">";
    $tabla .= "<thead><tr><th>Fecha</th><th>Mina</th><th>Dumper</th><th>Operador</th><th>Coordenada</th><th>Tipo</th><th>Observaciones</th><th>Hora1</th><th>Hora2</th><th>Hora3</th><th>Hora4</th><th>Hora5</th></tr></thead>";
