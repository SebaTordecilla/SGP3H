...
if ($total > 0) {
    ...
    $tabla .= "<thead><tr><th>N°Guía</th><th>Fecha</th><th>Hora</th><th>Mina</th><th>Patente</th><th>Chofer</th><th>Tonelaje</th><th>LeyVis</th><th></th></tr></thead>";
    while ($row = $resultado->fetch_assoc()) {
        ...
        $tabla .= "<td align=\"center\"><a href=\"#\" onclick=\"edit_guia_oxido('" . $row['id_lote'] . "','" . $row['id_guia'] . "','" . $row['fecha'] . "','" . $row['hora'] . "','" . $row['id_ubicacion'] . "','" . $row['num_guia'] . "','" . $row['id_patente'] . "','" . $row['id_chofer'] . "','" . $row['tonelaje'] . "','" . $row['leyvis'] . "')\"><small class=\"badge badge-success\">Edit</small></a></td>";
        $tabla .= "</tr>";
    }
    ...
    $tabla .= "<tfoot><tr><th></th><th></th><th></th><th></th><th></th><th></th><th>" . $ton_total . "</th><th>" . $promedio . "</th><th></th></tr></tfoot>";
    $tabla .= "</table>";
    echo $tabla;
}
