<tbody>
    ...
    ?>
            <tr>
                ...
                <td align="center"><a href="#" onclick="confirmar_disparo('<?php echo $row['id_disparo']; ?>')"><i class="nav-icon far fa-plus-square fondo_icono"></i></a></td>
            </tr>
    <?php
        }
