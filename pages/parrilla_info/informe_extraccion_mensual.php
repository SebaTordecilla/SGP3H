        ...
        <div class="container-fluid">
          ...
          <form>
            <div class="row">
              ...
              <div class="col-md-2">
                <div class="form-group">
                  <input type="button" class="btn btn-block btn-primary btn-lg naranjo" value="Informe" onclick="informe_extraccion_mensual()">
                </div>
              </div>
            </div>
          </form>
          ...
          <div class="card-body">
            ...
            <div id="target_report_extr_mensual" style="padding-top:10px;"></div>

            <div class="row">
              <div class="col-8">
                <div id="grafico_mes_extr" style="padding-top:10px;"></div>
              </div>
              <div class="col-4">
                <div id="grafico_oxido_sulfuro_extr" style="padding-top:10px;"></div>
              </div>
            </div>
            <div class="card card">
              <div id="tabla_report_extr_mensual" style="text-align:center;"></div>
            </div>
