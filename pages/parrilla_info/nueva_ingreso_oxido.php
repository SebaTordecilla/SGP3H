    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1><img src="../../dist/img/operaciones.png" width="60" height="60"> Viajes Óxido</h1>
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <input type="button" class="btn naranjo" value="Nuevo Lote" onclick="nuevo_lote_modal()">
                </div>
