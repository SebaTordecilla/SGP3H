    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1><img src="../../dist/img/operaciones.png" width="60" height="60"> Reporte Diario Extracción de Mineral</h1>
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <div class="btn-group">
                    <input type="date" class="form-control" id="report_fecha" name="report_fecha">
                  </div>
                </div>
                ...
                <div class="card-body">
                  ...
                  <div id="target_report_extr_diario" style="padding-top:10px;"></div>
                  
                  <div id="tabla_report_extr_diaria" style="text-align:center;"></div>
