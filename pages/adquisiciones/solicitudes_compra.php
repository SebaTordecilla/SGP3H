        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1><img src="../../dist/img/adquisiciones.png" width="60" height="60"> SOLICITUD DE COMPRA</h1>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
            </section>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <input type="button" class="btn naranjo" value="Nueva Solicitud" onclick="modal_nueva_solicitud()">
                                </div>
