...
try {
    $sql = "SELECT id_artsol, upper(descripcion) as descripcion, cantidad, stock, upper(proveedor) as proveedor FROM articulos_solicitados where id_pedido = " . $id_pedido . ";";
    foreach ($db->query($sql) as $row) {
        ...
        $tabla .= "<td align=\"center\"><a href=\"#\" onclick=\"del_art_sol('" . $row['id_artsol'] . "','" . $id_pedido . "')\"><small class=\"badge badge-danger\">-</small></a></td>";
    }
