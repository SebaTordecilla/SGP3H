        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1><img src="../../dist/img/adquisiciones.png" width="60" height="60">INFORME SOLICITUD DE COMPRAS</h1>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
            </section>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    <select class="form-control" id="mes_sol_informe" name="mes_sol_informe">
                                        <option value=""></option>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <select class="form-control" id="ano_sol_informe" name="ano_sol_informe">
                                        <option value=""></option>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <input type="button" class="btn btn-block btn-primary btn-lg naranjo" value="Informe" onclick="informe_mensual_solicitudes()">
                                </div>
                            </div>
                        </div>
                    </form>
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div id="tabla_sol_inf" style="padding-top:10px;"></div>
